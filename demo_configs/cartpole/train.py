"""RoboSpec Training Script — RoboSpec-Cartpole-v0
...
gym.register(
    ...
    kwargs={
        "env_cfg_entry_point": "cartpole_cartpole_env_cfg:CartpoleCartpoleEnvCfg",
...
if not os.path.exists(_TRAIN_SCRIPT):
    ...
    print("Install the framework: ./isaaclab.sh --install rl_games")
    sys.exit(1)
...
if "--task" not in _user_args:
    _user_args = ["--task", "RoboSpec-Cartpole-v0"] + _user_args
...
print(f"{'='*70}")
print(f"  RoboSpec Training: RoboSpec-Cartpole-v0")
print(f"  Framework: rl_games")
